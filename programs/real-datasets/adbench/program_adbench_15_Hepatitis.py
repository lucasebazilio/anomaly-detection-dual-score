...
# Save results to CSV
df_results.to_csv("adbench_results_15_Hepatitis.csv", index=False)

print("Results saved to 'adbench_results_15_Hepatitis.csv'.")
...
files.download("adbench_results_15_Hepatitis.csv")
