...
# Save results to CSV
df_results.to_csv("adbench_results_14_glass.csv", index=False)

print("Results saved to 'adbench_results_14_glass.csv'.")
...
files.download("adbench_results_14_glass.csv")
