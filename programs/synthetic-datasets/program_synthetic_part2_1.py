...
datasets_part2_1 = {k: datasets_second_half[k] for k in second_half_dataset_names[:quarter_split]}

print(f"Processing second half (Part 2.1): {len(datasets_part2_1)} datasets...")

# Store results
results = []
processed_count = 0  # Counter for processed datasets

# Iterate through datasets in Part 2.1
for dataset_name, df in datasets_part2_1.items():
...
df_synthetic_part2_1 = pd.DataFrame(results)

# Save Part 2.1 to CSV
df_synthetic_part2_1.to_csv("synthetic_ad_results_part2_1.csv", index=False)

print("Part 2.1 of synthetic datasets processed and saved.")

# Download the CSV file for local storage
from google.colab import files
files.download("synthetic_ad_results_part2_1.csv")
